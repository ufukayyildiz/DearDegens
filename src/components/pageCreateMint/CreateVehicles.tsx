...
import { categoryVehicles } from "@/src/lib/categories/Vehicles"
...
import { VehicleListingCreationRequest } from "@/src/lib/validators/validateListingVehicle"
...
export default function CreateVehicle() {
  ...
  const subcategories = categoryVehicles.filter((item) => {
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      const payload: VehicleListingCreationRequest = {
        tab: "Vehicles",
        category: category,
                  ...
                  <div className="relative w-full flex-col">
                    ...
                    >
                      ...
                      <SelectContent className="max-h-96 overflow-auto p-2">
                        {categoryVehicles.map((item, index) => (
                          <div key={index}>
                            <SelectItem
