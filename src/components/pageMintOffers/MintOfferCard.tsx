...
export default function MintOfferCard({ adOffer }: MintOfferCardProps) {
  ...
  return (
    <div className="mx-auto mb-3 flex w-11/12 flex-col justify-between rounded-2xl border border-muted bg-background p-2 text-primary shadow-lg transition duration-75 hover:scale-[0.99]">
      {adOffer.itemName && (
