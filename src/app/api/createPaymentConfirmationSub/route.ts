...
import { subscriptionResponseData, productType } from "@/src/types/subscription"
...
export async function POST(request: any) {
  ...
  if (request.method === "POST") {
    ...
    const responseData = parse(body) as subscriptionResponseData
