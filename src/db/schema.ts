...
export const listingsGeneral = mysqlTable("listingGeneral", {
  ...
  subCategory: varchar("description", { length: 191 }).notNull(),
  images: varchar("description", { length: 191 }).notNull(),
  brand: varchar("description", { length: 191 }).notNull(),
  model: varchar("description", { length: 191 }).notNull(),
  meetup: varchar("description", { length: 191 }).notNull(),
